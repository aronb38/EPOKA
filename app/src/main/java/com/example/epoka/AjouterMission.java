...
public class AjouterMission extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //recuperation des elements XML graces aux ID
        ...
        //recuperation des données de l'intent pour l'interface
        ...
        btnQuitter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                public void onClick(View v) {
                    ...
                    // Récupére l'id, nom et prénom depuis l'intent
                    String id = getIntent().getStringExtra("id");
                    String nom = getIntent().getStringExtra("nom");
                    String prenom = getIntent().getStringExtra("prenom");
                    ...
                    // Ajouter l'id, nom et prénom à l'Intent du haut
